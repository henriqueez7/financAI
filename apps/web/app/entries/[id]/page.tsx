  ...
  return (
    <>
      ...
      <motion.div
        role="dialog"
        aria-modal="true"
        aria-labelledby="delete-edit-entry-title"
        aria-describedby="delete-edit-entry-description"
        onKeyDown={(event) => {
      ...
      >
        ...
        <h2 id="delete-edit-entry-title" className="mt-5 text-xl font-bold">Excluir lançamento?</h2>

        <p id="delete-edit-entry-description" className="mt-3 text-sm leading-6 text-[#6d7971]">
