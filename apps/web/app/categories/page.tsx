        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 text-xs text-[#78847c]">
              Organize receitas e despesas de forma inteligente.
            </p>
          </div>
      ...
      >
        ...
        >
          ...
          <SummaryCard
            ...
            description="Categorias de entrada"
            icon={ArrowUpRight}
            variant="positive"
          />
          ...
          <SummaryCard
            ...
            description="Categorias de saída"
            icon={ArrowDownRight}
            variant="negative"
          />
          ...
          <SummaryCard
            ...
            description="Disponíveis em lançamentos"
            icon={FolderOpen}
            variant="positive"
          />
        </section>
